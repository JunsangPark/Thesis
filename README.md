...
+ **Application**
   ...
   - [The determinants of consumers’ online shopping cart abandonment, Kukar-Kinney et al.(2010)](https://link.springer.com/article/10.1007/s11747-009-0141-5)
   - [Deep content-based music recommendation, Oord et al.(2013)](https://papers.nips.cc/paper/5004-deep-content-based-music-recommendation)
   - [Dynamic Pricing and Learning: Historical Origins, Current Research, and New Directions, Boer(2015)](https://ris.utwente.nl/ws/files/5090800/memo2025.pdf)
   - [Dynamic Pricing in a Labor Market: Surge Pricing and Flexible Work on the Uber Platform, Chen et al.(2015)](https://www.anderson.ucla.edu/faculty_pages/keith.chen/papers/SurgeAndFlexibleWork_WorkingPaper.pdf)
   ...
   - [Prediction of Ventricular Tachycardia One Hour before Occurrence Using Artificial Neural Networks, Lee et al.(2016)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4999952/)
   ...
   - [Cardiologist-Level Arrhythmia Detection with Convolutional Neural Networks, Rajpurkar et al.(2017)](https://arxiv.org/pdf/1707.01836.pdf)
   ...
   - [Mobile shopping cart abandonment: the roles of conflicts, ambivalence, and hesitation, Huang et al.(2017)](https://www.sciencedirect.com/science/article/abs/pii/S0148296317305027)
   - [Pixie: A System for Recommending 3+ Billion Items to 200+ Million Users in Real-Time, Eksombatchai et al.(2017)](https://arxiv.org/abs/1711.07601)
...
Convolutional Neural Networks for Stock Price Prediction, Chen and Wei(2018)](www.sdspeople.fudan.edu.cn/zywei/paper/chen-cikm2018.pdf)
   ...
   - [Cardiologist-level arrhythmia detection and classification in ambulatory electrocardiograms using a deep neural network, (2019)](https://www.nature.com/articles/s41591-018-0268-3)
...
+ **DNN on graph**
   ...
   - [Modeling polypharmacy side effects with graph convolutional networks, Zitnik et al.(2018)](https://arxiv.org/abs/1802.00543)
...
+ **Image**
   ...
   - [Inception-v4, Inception-ResNet and the Impact of Residual Connections on Learning, Szegedy et al.(2016)](https://arxiv.org/pdf/1602.07261.pdf)
   ...
   - [Deep convolution neural networks for automatic eyeglasses removal, Liang et al.(2017)](https://www.semanticscholar.org/paper/Deep-Convolution-Neural-Networks-for-Automatic-Liang-Xue/2635faaef911113813d51b4808b6f57a97862130)
   ...
   - [High-resolution image synthesis and semantic manipulation with conditional GANs, Wang et al.(2018)](https://arxiv.org/abs/1711.11585)
   ...
   - [GPipe: Easy Scaling with Micro-Batch Pipeline Parallelism, Huang et al.(2019)](https://arxiv.org/pdf/1811.06965.pdf) 
   ...
   - [Self-training with Noisy Student improves ImageNet classification, Xie et al.(2019)](https://arxiv.org/pdf/1911.04252.pdf)
...
+ **Time Series**
   ...
   - [Deep Learning for time series classification: a review, Fawaz(2019)](https://arxiv.org/abs/1809.04356)
